-- Release Notes --
-- Make sure to update the client.conf file to add this line -> define( 'CLIENT_CODEREF', 'TWS');
...
(300, 'Text', 'employee_name', NULL, NULL, NULL, NULL, '$jobseeker->getFormattedName()', 0);
...
(300, 3, 'client_form', 1, 'job_seeker'),
(301, 3, 'client_form', 2, 'admin');
...
(3, 'client_form', 69, 0, 1, 1, 1, 450, 610, 0, 0, 'fontsize=10');
