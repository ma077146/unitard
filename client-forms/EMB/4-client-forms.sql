-- Release Notes --
-- Make sure to update the client.conf file to add this line -> define( 'CLIENT_CODEREF', 'EMB');
...
(400, 'Text', 'employee_name', NULL, NULL, NULL, NULL, '$jobseeker->getFormattedName()', 0);
...
(400, 4, 'client_form', 1, 'job_seeker'),
(401, 4, 'client_form', 2, 'admin');
...
(4, 'client_form', 69, 0, 1, 1, 1, 450, 610, 0, 0, 'fontsize=10');
