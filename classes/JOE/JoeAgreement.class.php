<?php
  /**
   * Get\'s Joe to Agree JOE ClientForm subclass.
   * @package WebForm\Form\ClientForm\JOE
   */
   ...
   * @package WebForm\Form\ClientForm\JOE
   */
  class JOE_WebForm_Form_ClientForm_JoeAgreement extends WebForm_Form_ClientForm {
