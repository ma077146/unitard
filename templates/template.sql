-- Release Notes --
-- Make sure to update the client.conf file to add this line -> define( 'CLIENT_CODEREF', '#CLIENT-NAME');
...
(#FORM-STEP-ID, #FORM-NUMBER, 'client_form', 1, 'job_seeker'),
(#TWO-FORM-STEP-ID, #FORM-NUMBER, 'client_form', 2, 'admin');
...
(#FORM-NUMBER, 'client_form', 69, 0, 1, 1, 1, 450, 610, 0, 0, 'fontsize=10');
