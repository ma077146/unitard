-- Release Notes --
-- Make sure to update the client.conf file to add this line -> define( 'CLIENT_CODEREF', 'JOE');
...
(800, 'Text', 'employee_name', NULL, NULL, NULL, NULL, '$jobseeker->getFormattedName()', 0);
...
(800, 8, 'client_form', 1, 'job_seeker'),
(801, 8, 'client_form', 2, 'admin');
...
(8, 'client_form', 69, 0, 1, 1, 1, 450, 610, 0, 0, 'fontsize=10');
